...
/**
 * Servlet implementation class Empalldetails
 */
@WebServlet("/Empalldetails")
public class Empalldetails extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String page="empalldetails.jsp";
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Empalldetails() {
        super();
